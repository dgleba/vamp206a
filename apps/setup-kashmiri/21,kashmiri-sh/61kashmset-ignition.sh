...
: <<'BLOCKCOMMENT'
  ...
  Purpose:   
        setup kashmiri1 server for PLC data historian with ingition OPCUA  --  optional..  and influxdb etc.
...
# log all terminal activity to file.
#
mkdir -p termlog
script ~/termlog/termlog$(date +"__%Y.%m.%d_%H.%M.%S").txt.log.sh
# print the typescript file as plain text..
# col -bp < ~/screen22.log
...
# wget https://s3.amazonaws.com/files.inductiveautomation.com/release/ia/build7.9.6/20180129-1411/Ignition-7.9.6-linux-x64-installer.run
  # 2018-12-20 09:17AM
wget https://s3.amazonaws.com/files.inductiveautomation.com/release/ia/build7.9.10/20181128-1303/zip-installers/Ignition-7.9.10-linux-x64-installer.run
chmod +x Ignition-7.9.10-linux-x64-installer.run  &&  sudo ./Ignition-7.9.10-linux-x64-installer.run
